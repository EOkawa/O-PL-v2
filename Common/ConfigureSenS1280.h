#ifndef CONFIGURESENS1280_H_INCLUDED
#define CONFIGURESENS1280_H_INCLUDED


/** This sample configuration is specific to SenS 1280-VSTP cameras                **/
/*                                                                                   */
...
void ConfigureDevice( NITLibrary::NITDevice* dev )
{
    ...
    /* Each time a parameter is changed, the ConfigObserver is called          */
		...
		//You can uncomment the line below to choose between GlobalShutter or Gated
...
#endif // CONFIGURESENS1280_H_INCLUDED
