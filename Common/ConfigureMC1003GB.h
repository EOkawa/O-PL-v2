#ifndef CONFIGUREMC1003GB_H_INCLUDED
#define CONFIGUREMC1003GB_H_INCLUDED
...
void ConfigureDevice( NITLibrary::NITDevice* dev )
{
    ...
    /* Each time a parameter is changed, the ConfigObserver is called          */
		...
		dev->setParamValueOf( "OutputType", "Correction_Grey" );  //When OutputType Correction_Grey is selected an AGC is applied in the camera
		...
		dev->setParamValueOf( "Mode", "Snapshot" );               //Set Mode
...
#endif // CONFIGUREMC1003GB_H_INCLUDED
