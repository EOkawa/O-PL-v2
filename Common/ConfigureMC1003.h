#ifndef CONFIGUREMC1003_H_INCLUDED
#define CONFIGUREMC1003_H_INCLUDED


/** This sample configuration is specific to MC1003 Gray cameras                    **/
...
void ConfigureDevice( NITLibrary::NITDevice* dev )
{
    ...
    /* Each time a parameter is changed, the ConfigObserver is called          */
		...
		dev->setParamValueOf( "Mode", "GlobalShutter" );          //Set Mode
        dev->setParamValueOf( "Exposure Time", 10000.0 );          //Set Exposure Time
...
#define USE_USB
#if CAMERA_MODEL == MC1003
	#define NEED_AGC
#endif
#endif // CONFIGUREMC1003_H_INCLUDED
