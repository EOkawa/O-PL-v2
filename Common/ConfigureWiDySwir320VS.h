#ifndef CONFIGUREWIDYSWIR320VS_H_INCLUDED
#define CONFIGUREWIDYSWIR320VS_H_INCLUDED
...
void ConfigureDevice( NITLibrary::NITDevice* dev )
{
    ...
    /* Each time a parameter is changed, the ConfigObserver is called          */
		...
		dev->setParamValueOf( "Pixel Clock", "12.5MHz" );         //Set clock frequency
...
#endif // CONFIGUREWIDYSWIR320VS_H_INCLUDED
