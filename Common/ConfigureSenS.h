#ifndef CONFIGURESENS_H_INCLUDED
#define CONFIGURESENS_H_INCLUDED


/** This sample configuration is specific to SenS 640-VST cameras                **/
/*                                                                                   */
...
void ConfigureDevice( NITLibrary::NITDevice* dev )
{
    ...
    /* Each time a parameter is changed, the ConfigObserver is called          */
        ...
        dev->setParamValueOf( "Cds", "On" );                      //Set Cds on or off
...
#endif // CONFIGURESENS_H_INCLUDED
