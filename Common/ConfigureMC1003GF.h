#ifndef CONFIGUREMC1003GF_H_INCLUDED
#define CONFIGUREMC1003GF_H_INCLUDED


/** This sample configuration is specific to MC1003_1GB  cameras                    **/
...
void ConfigureDevice( NITLibrary::NITDevice* dev )
{
    ...
    /* Each time a parameter is changed, the ConfigObserver is called          */
		...
		dev->setParamValueOf( "OutputType", "Correction_Color" );  //When OutputType Correction_Color is selected a debayering is applied in the camera
		...
		dev->setParamValueOf( "ReadOutMode", "Global" );          //Set Read out Mode (can be global, rolling or differential)
...
#endif // CONFIGUREMC1003GF_H_INCLUDED
